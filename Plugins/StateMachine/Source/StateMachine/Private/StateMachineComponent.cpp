...
bool UStateMachineComponent::SwitchState(FGameplayTag NewStateTag)
{
	...
	if (bDebug)
	{
		UE_LOG(LogTemp, Warning,
			TEXT("Couldn\'t switch state for %s because it is already in %s"),
			*GetOwner()->GetName(),
